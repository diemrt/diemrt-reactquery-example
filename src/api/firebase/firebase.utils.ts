...
export const FirebaseErrorMessagesIt = {
  ...
  "auth/invalid-credential": "Le credeziali inserite non sono valide."
};
...
export const translateFirebaseErrorMessage = (
  ...
  if (error.code) {
    return {
      message: FirebaseErrorMessagesIt[error.code as "auth/user-not-found" | "auth/too-many-requests" | "auth/wrong-password"],
    };
  }
