    ...
    >
      ...
      >
        <ul className="space-y-1.5">
          <li>
            <NavLink
              className="flex items-center gap-x-3.5 py-2 px-2.5 bg-yellow-200 text-sm text-slate-700 rounded-lg hover:bg-gray-100 dark:bg-gray-900 dark:text-white dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
              to="/"
            >
              <svg
