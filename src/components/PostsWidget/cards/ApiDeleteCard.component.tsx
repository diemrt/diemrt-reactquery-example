...
import { deletePostMutation } from "../../../api/posts/posts.api";
  ...
  return (
    <div className="py-8 first:pt-0 last:pb-0">
      <div className="flex gap-x-5">
        <span className="inline-flex h-fit items-center rounded-md bg-red-50 px-2 py-1 text-xs font-medium text-red-700 ring-1 ring-inset ring-red-600/20">
          DELETE
        </span>
        <div className="w-full">
          ...
          <p className="mt-1 w-full text-gray-500">
            Permette di eliminare un singolo post.
          </p>
